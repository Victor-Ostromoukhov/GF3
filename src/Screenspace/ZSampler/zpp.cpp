...
void initZPPTable( ZPPTable& table, const int maxdim, unsigned int *production, const int size )
{
    ...
    std::random_device seed;    // utilise le generateur materiel
...
void initZPPTable( ZPPTable& table, const int maxdim )
{
    initZPPTable(table, maxdim, ART_2x2_PRODUCTION, 4096);
}

void randomZPPTable( ZPPTable& table, const int maxdim )
{
    initZPPTable(table, maxdim, nullptr, 4096);
}
